...
// Vendored from React Bits (reactbits.dev). Kept close to the original source
// since a WebGL shader effect doesn't decompose into smaller components.
// The only changes from upstream: the Tailwind className is replaced with a
// plain CSS class (this project has no Tailwind build step), and the effect
